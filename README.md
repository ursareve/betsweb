# Fury - Angular 16+ Material Design Admin Template
## Introduction

Fury is a creative material design admin template built with Angular 16+ and the Angular-CLI. It extends the Material
...
* [Fury - Angular 16+ Material Design Admin Template](#fury---angular-6+-material-design-admin-template)
...
assistance and allows you to generate basically all Angular 16+-Components there are. *(In a smart way!)*

To generate our first `component` we simply open up a terminal and navigate in our Angular 16+-App. Now we simply
...
These were the first steps with the awesome Angular-CLI and Angular 16+. Following we are going to get more in detail
about developing with Angular-CLI and using the power of Angular 16+ right.
...
Receiving data from a server to process or display it in Angular 16+ can be quite tricky with the new observables and
...
* [RxJS](//github.com/ReactiveX/rxjs) - Angular 16+ Dependency - A new approach to how data can be handled in
  Observables.
